...
for k=1:14
    for j=1:N
        L=length(pv{1,k+6});          %夏季光伏出力
        L1=length(wt{1,k+6});         %夏季风机出力
        for i=1:L-1                    %光伏
        ...
        for i=1:L1-1                    %风机        
            ...
            s1=subs(s,{'a(i)','coe(i,1)','coe(i,2)','coe(i,3)','coe(i,4)'},{awt{1,k+6}(i),coewt{1,k+6}(i,1),coewt{1,k+6}(i,2),coewt{1,k+6}(i,3),coewt{1,k+6}(i,4)});
